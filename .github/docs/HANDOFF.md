...
| `./.venv/bin/python -m coverage report --fail-under=95 --include='cli/src/findplus/places/geofence.py,cli/src/findplus/groups/presence.py,cli/src/findplus/groups/quorum.py,cli/src/findplus/alerts/dispatch.py,cli/src/findplus/alerts/dispatch_core.py,cli/src/findplus/alerts/dispatch_send.py,cli/src/findplus/alerts/channels_field.py,cli/src/findplus/alerts/retry.py,cli/src/findplus/alerts/retry_classify.py'` | the critical path is at 98 percent | gate-run-log.md, macOS step m |
