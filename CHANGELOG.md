...
- Playwright tests for the Alerts tab
- Real README/wiki screenshots (dashboard, timeline, places, groups, alerts, lock screen)
  in light and dark mode, regenerated by `packaging/scripts/screenshots.py`
