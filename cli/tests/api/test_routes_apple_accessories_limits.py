"""POST /api/apple/accessories: the 64 KiB cap, streaming/chunked-upload
guards, malformed-plist handling, and the uploaded file's 0600 mode. Split
from test_routes_apple_accessories.py (E13 stage 2, size cap).
"""
