...
class AlertRule(Base):
    ...
    __table_args__ = (
        CheckConstraint("channel IN ('telegram','webhook')", name="ck_alert_rules_channel"),
...
class AlertDelivery(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("status IN ('sent','failed','skipped')", name="ck_alert_deliveries_status"),
        UniqueConstraint("rule_id", "event_kind", "event_id", name="uq_alert_deliveries_dedup"),
    )
