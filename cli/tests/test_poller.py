...
Provider-resolution failures live in test_poller_providers.py and the shared
fakes in poller_fakes.py; this file was 416 lines before that split.
"""
...
from tests.poller_fakes import FakeProvider, _last_run, _obs_count
